...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title><?php echo $company['cname']; ?> | <?php echo $L_['lgn_title']; ?></title>
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					...
					<form  class="fh5co-form animate-box" data-animate-effect="fadeIn" name="form1" id="userForm" method="post" novalidate>
						...
						<h2><?php echo $L_['lgn_signup']; ?></h2>
						<?php
						if(isset($_POST['user'])&& md5($_POST['pwd'])) {
							$error = verify_users($_POST['user'],md5(PASS_SALT.$_POST['pwd']),$_POST['estado']);	 								
						} else {
								echo '
									<div class="form-group">
										<label for="username" class="sr-only">Username</label>
										<input type="text" class="form-control" id="user-name" name="user" placeholder="'.$L_['lgn_username'].'" tabindex="1" required autofocus autocomplete="off">
									</div>
									<div class="form-group">
										<label for="password" class="sr-only">Password</label>
										<input type="password" class="form-control" id="pwd" name="pwd" placeholder="'.$L_['lgn_password'].'" tabindex="2" require  autocomplete="off">
									</div>
									<div class="form-group">
										<label for="remember"><input type="checkbox" id="remember"> '.$L_['lgn_remember'].'</label>
									</div>
									<div class="form-group">
										<p>'.$L_['lgn_nregister'].' <a href="signup">'.$L_['lgn_sup'].'</a> | <a href="recover-password">'.$L_['lgn_forgot'].'</a> | <a href="index">HOME</a></p>
									</div>
									<div class="form-group">
										<input type="submit" value="'.$L_['lgn_sup2'].'" class="btn btn-success">
									</div>';
								}	
						?>
					</form>
