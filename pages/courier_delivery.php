...
<head>
	...
	<title><?php echo $company['cname']; ?> | Etiam ornare justo at magna </title>
...
<body class="single">
	<div id="wrapper">
		...
		<main id="main" class="site-main">
			...
			<h1>Etiam ornare justo at magna</h1>
			</br>
			</div><!-- .container -->
					...
					<div class="col-md-8 main-content">
						<article class="post">
							<div class="entry-content">
								<img src="../assets/images/placeholder/courier_delivery.jpg" alt="">
