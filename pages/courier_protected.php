...
<head>
	...
	<title><?php echo $company['cname']; ?> | Are Download Files Protected </title>
...
<body class="single">
	<div id="wrapper">
		...
		<main id="main" class="site-main">
			...
			<h1>Are Download Files Protected</h1>
			</br>
			</div><!-- .container -->
					...
					<div class="col-md-8 main-content">
						<article class="post">
							<div class="entry-content">
								<img src="../assets/images/placeholder/courier_protected.jpg" alt="">
