...
<head>
	...
	<title><?php echo $company['cname']; ?> | <?php echo $L_['p_title']; ?></title>
...
<body class="single-forum">
	<div id="wrapper">
		...
		<header id="header" class="site-header">
			<div class="container clearfix">
				<div class="site-brand">
					<a class="logo" href="index.html"><img src="dashboard/logo-image/image_logo.php?id=1" alt=""></a>
				</div><!-- .site-brand -->
		...
		<main id="main" class="site-main">
			<section class="page-title" style="background-image: url(assets/images/placeholder/privacy.jpg);">
				<div class="container">
					<h1> <?php echo $L_['p_mainprivacy']; ?></h1>
				</div><!-- .container -->
			</section><!-- .page-title -->
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 main-content">
						<h3 class="forum-title"> <?php echo $L_['p_privacy']; ?></h3>
						<div id="bbpress-forums">
							<ul class="bbp-topics">
								<li class="bbp-body">
									<div class="bbp-post">
										<div class="bbp-topic-content">											
											<p> <?php echo $L_['p_content1']; ?></p>
											<ul>
												<li><?php echo $L_['p_licontent1']; ?></li>
												<li><?php echo $L_['p_licontent2']; ?></li>
												<li><?php echo $L_['p_licontent3']; ?></li>
											</ul>
											<p><?php echo $L_['p_content2']; ?></p>
							...
							<ul class="bbp-topics bbp-replies">
								<li class="bbp-body">
									<div class="bbp-post">
										<div class="bbp-topic-content">											
											<p><?php echo $L_['p_content3']; ?></p>
										</div><!-- .bbp-topic-content -->	
										</br>
										<div class="bbp-topic-content">											
											<p><?php echo $L_['p_content4']; ?></p>
										</div><!-- .bbp-topic-content -->	
									</div><!-- .bbp-post -->
								</li>
							</ul>
