					...
					<table ui-jq="dataTable" class="table table-striped b-t b-b">
						...
						<tbody>
						  <tr>
							  ...
							  <td align="center"><span class="label <?php echo $row['payment']; ?> label-large"><?php echo $row['payment']; ?></span>&nbsp;<span class="label <?php echo 
                                                                                             $row['paymode']; ?> label-large"><?php echo $row['paymode']; ?></span></td> 
										...
										?>
											<?php if(isset($_SESSION['user_type']) && $_SESSION['user_type'] == 'Administrator') { ?>															  
											 <td align="center">
											  ...
											  <td align="center"><a target="_blank" href="print-invoice/ticket-print-online.php?cid=<?php echo codificar($row['cid']); ?>">
												<img src="img/ticket.png"  height="20" width="20"></a></td>
											  <td align="center">
											  ...
											  <td align="center">
												  <a data-target="#con-close-modal-online-photo<?php echo $row['cid']; ?>" data-toggle="modal">
												  <img src="img/photo.png"  height="23" width="23"></a>
											  </td>
											  <td><font color="#000"><?php echo $row['cons_no']; ?></td>
											  <td><strong><?php echo $_SESSION['ge_curr']; ?>&nbsp;<?php echo $row['shipping_subtotal']; ?></strong></td>															  
											  <td align="center"><span class="label <?php echo $row['payment']; ?> label-large"><?php echo $row['payment']; ?></span>&nbsp;<span class="label <?php echo 
                                                                                             $row['paymode']; ?> label-large"><?php echo $row['paymode']; ?></span></td>															  
