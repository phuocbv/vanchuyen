                        ...
                        <div class="col wrapper">
                            ...
                            <div class="table-responsive">
                                <table ui-jq="dataTable" class="table table-striped b-t b-b">
                                    ...
                                    <tr>
                                        <?php
                                        $result3 = mysql_query("SELECT c.cid, c.tracking, c.cons_no, c.book_mode, c.locker, c.ship_name, c.rev_name, c.shipping_subtotal, c.pick_date, c.user, s.color, c.status, c.paymode, c.payment
                                        ...
                                        <?php if (isset($_SESSION['user_type']) && $_SESSION['user_type'] == 'Administrator') { ?>
                                            <td align="center">
                                                <a href="#" alt="Borrar Registro"
                                                   onclick="del_list_admin(<?php echo $row['cid']; ?>);">
                                                    <img src="img/delete.png" height="20" width="18"></a></td>
                                        <?php } ?>
                                        <td align="center"><a
                                                    href="edit-courier.php?cid=<?php echo codificar($row['cid']); ?>">
                                                <img src="img/edit.png" height="20" width="18"></a></td>
                                        <td align="center"><a data-target="#con-close-modal<?php echo $row['cid']; ?>"
                                                              data-toggle="modal">
                                                <img src="img/update-status.png" height="20" width="20"></a></td>
                                        <td align="center"><a target="_blank"
                                                              href="print-invoice/invoice-print.php?cid=<?php echo codificar($row['cid']); ?>">
                                                <img src="img/print.png" height="20" width="20"></a></td>
                                        <td align="center"><a target="_blank"
                                                              href="print-invoice/ticket-print.php?cid=<?php echo codificar($row['cid']); ?>">
                                                <img src="img/ticket.png" height="20" width="20"></a></td>
                                        <td align="center"><a
                                                    href="barcode/courier/html/BCGcode39.php?tracking=<?php echo $row['tracking']; ?>"
                                                    target="_blank">
                                                <img src="img/barcode.png" height="20" width="20"></a></td>
                                        <td class="gentxt" align="center">
                                            <a href="settings/add_courier/status_delivered.php?tracking=<?php echo $row['tracking']; ?>"
                                               onclick="return confirm('<?php echo $DELIVERY; ?>')">
                                                <img src="img/delivery.png" height="20" width="20"></a></td>
                                        <td align="center">
                                            <a data-target="#con-close-modal-photo<?php echo $row['cid']; ?>"
                                               data-toggle="modal">
                                                <img src="img/photo.png" height="23" width="23"></a>
                                        </td>
                                        ...
                                        <td align="center"><span
                                                    ...
                                                    class="label <?php echo
                                                    $row['paymode']; ?> label-large"><?php echo $row['paymode']; ?></span>
                                        </td>
                    ...
                    <div class="panel wrapper">
                        <div class="row">
                            <div class="col-md-10 b-r b-light no-border-xs">
                                ...
                                <h4><i class="icon-envelope-open"></i>&nbsp; <strong><span
                                                class="text-danger text-uppercase m-b-15 m-t-10"><?php echo $numero2; ?></span></strong>&nbsp;<?php echo $LISTAENVIORESERVAONLINE; ?></a>
                                </h4>
                                <br>
                                <div class="table-responsive">
                                    <table ui-jq="dataTable" class="table table-striped b-t b-b">
                                        ...
                                        <tr>
                                            ...
                                            <?php if (isset($_SESSION['user_type']) && $_SESSION['user_type'] == 'Administrator') { ?>
                                                <td align="center">
                                                    <a href="#"
                                                       onclick="del_list_online(<?php echo $row['cid']; ?>);"><img
                                                                src="img/delete.png" height="20" width="18"></a></td>
                                            <?php } ?>
                                            <td align="center">
                                            ...
                                            <td align="center">
                                                <a data-target="#con-close-modal-status-online<?php echo $row['cid']; ?>"
                                                   data-toggle="modal">
                                                    <img src="img/update-status.png" height="20" width="20"></a>
                                            </td>
                                            <td align="center">
                                                <a target="_blank"
                                                   href="print-invoice/invoice-print-online.php?cid=<?php echo codificar($row['cid']); ?>">
                                                    <img src="img/print.png" height="20" width="20"></a>
                                            </td>
                                            <td align="center"><a target="_blank"
                                                                  href="print-invoice/ticket-print-online.php?cid=<?php echo codificar($row['cid']); ?>">
                                                    <img src="img/ticket.png" height="20" width="20"></a></td>
                                            <td align="center">
                                                <a href="barcode/courier-online/html/BCGcode39.php?cons_no=<?php echo $row['cons_no']; ?>"
                                                   target="_blank">
                                                    <img src="img/barcode.png" height="20" width="20"></a>
                                            </td>
                                            <td align="center">
                                                <a data-target="#con-close-modal-online<?php echo $row['cid']; ?>"
                                                   data-toggle="modal">
                                                    <img src="img/delivery.png" height="20" width="20"></a>
                                            </td>
                                            <td align="center">
                                                <a data-target="#con-close-modal-online-photo<?php echo $row['cid']; ?>"
                                                   data-toggle="modal">
                                                    <img src="img/photo.png" height="23" width="23"></a>
                                            </td>
                                            <td><font color="#000"><?php echo $row['cons_no']; ?></td>
                                            <td><strong><?php echo $_SESSION['ge_curr']; ?>
                                                    &nbsp;<?php echo $row['shipping_subtotal']; ?></strong></td>
                                            <td align="center"><span
                                                        class="label <?php echo $row['payment']; ?> label-large"><?php echo $row['payment']; ?></span>&nbsp;<span
                                                        class="label <?php echo
                                                        $row['paymode']; ?> label-large"><?php echo $row['paymode']; ?></span>
...
<?php include("modal-status/modal-update-photo.php"); ?>

<!-- Modal Update online photo -->

<?php include("modal-status/modal-update-online-photo.php"); ?>
