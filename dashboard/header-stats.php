          ...
          <div class="row row-sm text-center">
            <div class="col-xs-6">
              ...
              <div class="panel padder-v item">
                <div class="h1 text-success font-thin h2"><?php echo $numero1; ?></div>
			...
			?>
              <a href="online-bookings.php" class="block panel padder-v bg-primary item">
                <span class="text-white font-thin h2 block"><?php echo $numero2; ?></span>
            ...
            <div class="col-xs-6">
              <a href class="block panel padder-v bg-info item">
                <span class="text-white font-thin h2 block">
            ...
            <div class="col-xs-6 m-b-md">
              <div class="r bg-light dker item hbox no-border">
                <div class="col dk padder-v r-r">
                  <div class="text-primary-dk font-thin h2"><span>
				 <?php echo $_SESSION['ge_curr']; ?><span data-plugin="counterup"><?php
          ...
          <div class="panel wrapper">
            <h4 class="font-thin m-t-none m-b text-muted"><?php echo $graficaventa; ?></h4>
				...
				<div class="table-responsive">
					 <div id="curve_chart" style="width: 900px; height: 247px"></div>
				</div>	
				  <!-- the chart code -->
          </div>
        </div>
