...
<title><?php echo $_SESSION['ge_cname']; ?> | <?php echo $enviospagoefectivo; ?></title>
<style type="text/css"> 
	...
	<body>
		<header>
		  <div class="estilo2">
			<div><span><?php echo $companys; ?>:</span><?php echo $_SESSION['ge_cname']; ?></div>
			<div><span><?php echo $empleado; ?>:</span><?php echo  $_SESSION['user_name']; ?></div>
			<div><span><?php echo $direccion1; ?>:</span><?php echo $_SESSION['ge_caddress']; ?></div>
			<div><span><?php echo $email1; ?>:</span> <a href="mailto:<?php echo $_SESSION['ge_cemail']; ?>"> <?php echo $_SESSION['ge_cemail']; ?></a></div>
