...
$id=  $_GET['id'];
$id = decodificar($id);
$sql = "SELECT * FROM online_booking WHERE id = $id "; 	
$result = dbQuery($sql);
					...
					<div class="row">
						...
						<fieldset class="col-md-6">
							...
							<div class="col-sm-2 form-group">
								<label class="control-label" ><?php echo $L_['lockerid']; ?><span class="required-field">*</span></label>
									<input type="text" name="locker" required value="<?php echo $locker; ?>" class="form-control" readonly="true">								 									   									                                  
							</div>
							</div>
							...
							<!-- Country and state -->
								<div class="row">
									...
									<div class="col-sm-3 form-group">
										...
										<select name="book_mode" class="form-control"  id="Bookingmode">
							...
							<div class="row">										
								...
								<div class="col-sm-3 form-group">
									<label class="text-danger"><strong><?php echo $company['currency']; ?>&nbsp;<?php echo $PrimerKilo; ?>&nbsp;<?php echo $_SESSION['ge_measure']; ?><strong></label>
									<input type="text" onblur="if(this.value == ''){this.value='0'}"  onKeyUp="suma();" id="sum1"   class="form-control" name="variable" value="3.25" required />
								</div>
								<div class="col-sm-3 form-group">
									<label class="text-danger"><strong><?php echo $company['currency']; ?>&nbsp;<?php echo $_SESSION['ge_measure']; ?>&nbsp;<?php echo $KiloAdicional; ?><strong></label>
									<input type="text" onblur="if(this.value == ''){this.value='0'}"  onKeyUp="suma();" id="sum6"   class="form-control" name="kiloadicional" value="3.25" required />
								</div>
								<div class="col-sm-3 form-group">
						...
						<fieldset class="col-md-6">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="cons_no"  value="<?php echo $_SESSION['ge_prefix']; ?>-<?php echo "".$cons_no; ?>" id="ConsignmentNo">
							</div>
							<div class="row">
								<!-- Destination Office -->
								<div class="col-sm-6 form-group">
								...
								<div class="col-sm-6 form-group">
									...
									<div class="demo-section k-content">
										<input class="form-control" name="deliverydate" required  value="<?php echo $collection_date; ?>" >
									</div><!-- input-group -->
								</div>
							</div>	
						</fieldset>
