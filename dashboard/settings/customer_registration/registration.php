...
require '../../requirelanguage.php';
		...
		$sql1 =mysql_query("SELECT email FROM tbl_clients WHERE email='$email'");
			if($row=mysql_fetch_array($sql1)){							
				...
				$sql1="INSERT INTO tbl_clients (locker,name,cc,email,phone,telefono,address,pwd,country,department,state,iso,zipcode,lang,estado,company,date,imagen,tipo_imagen) VALUES 	
				('$locker','$name','$cc','$email','$code_phone$phone','$code_phone1$telefono','$address','$pwdmd5','$country','$department','$state','$iso','$zipcode','$lang',1,'$company',curdate(), '".mysql_real_escape_string($string)."', '$tipo_imagen')";
			}
		dbQuery($sql1);
													...
													<tr bgcolor='#ffffff'>
														...
														<td>
															...
															<tbody>
																...
																<tr>
																	<td colspan='4' align='center'><h2 style='font-size:24px'>Locker information</h2></td>
																</tr>
																...
																<tr>
																	...
																	<td align='left' valign='middle'>
																		...
																		<div style='line-height:5px;padding:0;margin:0'>&nbsp;</div>
																		<div style='color:#404040;font-size:16px;line-height:16px;font-weight:lighter;padding:0;margin:0'><strong>$name</strong></div>
																		<div style='line-height:10px;padding:0;margin:0'>&nbsp;</div>
																	</td>																																
																	<td align='left' valign='middle'>
																		<h3 style='color:#404040;font-size:18px;font-weight:bold;padding:0;margin:0'>$lockerid:</h3>
																		<div style='line-height:5px;padding:0;margin:0'>&nbsp;</div>
																		<div style='color:#404040;font-size:16px;font-weight:lighter;padding:0;margin:0'><strong>$locker</strong></div>
																	</td>															
																</tr>
																<tr>
