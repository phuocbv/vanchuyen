...
$con = conexion();	
	...
	$resultado = $con->query("UPDATE manager_user SET name_parson = '$name_parson', name='$name', email='$email', phone='$phone', office='$office', estado='$estado', role='$role',
			date='$date', imagen='$data', tipo_imagen='$tipo' WHERE cid = '$cid'");
