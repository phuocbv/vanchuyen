...
$con = conexion();	
	...
	$resultado = $con->query("UPDATE tbl_clients SET name = '$name', cc = '$cc', address='$address', email='$email', phone='$phone', company='$company',
			country='$country', state='$state', iso='$iso', zipcode='$zipcode', lang='$lang', telefono='$telefono',imagen='$data',tipo_imagen= '$tipo' WHERE id = '$id'");

	} else {

		$resultado = $con->query("UPDATE tbl_clients SET name = '$name', cc = '$cc', address='$address', email='$email', phone='$phone', company='$company',
				 country='$country',state='$state', iso='$iso', zipcode='$zipcode', lang='$lang', telefono='$telefono' WHERE id = '$id'");
