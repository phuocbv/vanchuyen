...
// *************************************************************************
	...
	while($row = mysql_fetch_array($result1)) {
																	...
																	<tr>
																		<td align='center'>
																			<div style='text-align:center;width:100%;padding:40px 0'>
																				...
																				<tbody>
																					<tr>
																						<td align='center' style='margin:0;text-align:center'><a href='$web' style='font-size:18px;font-family:HelveticaNeue-Light,Arial,sans-serif;line-height:22px;text-decoration:none;color:#ffffff;font-weight:bold;border-radius:2px;background-color:#00a3df;padding:14px 40px;display:block' target='_blank'>See shipping!</a></td>
																					</tr>
																				</tbody>
																				</table>
																			</div>
	   ...
	   echo "<script type=\"text/javascript\">
				alert(\"'$_POST[name]' Thank you for booking online\");
