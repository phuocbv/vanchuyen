...
$con = conexion();	
	...
	$resultado = $con->query("UPDATE tbl_clients SET name = '$name', cc = '$cc', address='$address', email='$email', phone='$phone', company='$company',
			country='$country', department='$department', state='$state', iso='$iso', zipcode='$zipcode', telefono='$telefono',pwd='$pwdmd5',imagen= '$data',tipo_imagen= '$tipo' WHERE id = '$id'");

} else {

	$resultado = $con->query("UPDATE tbl_clients SET name = '$name', cc = '$cc', address='$address', email='$email', phone='$phone', company='$company',
			country='$country', department='$department', state='$state', iso='$iso', zipcode='$zipcode', telefono='$telefono' WHERE id = '$id'");
