								...
								<div align="center">
                                        ...
                                        <table border="0" align="center">
                                            <form method="get" class="form-inline">
                                                <tr>
                                                    ...
                                                    <td><i class="icon-append fa fa-calendar"></i>&nbsp;&nbsp;<input type="date" class="accounting" name="date" value="<?php echo $date?>"></td>
                                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-lg btn-success"><i class="icon-search"></i> <strong>Search</strong></button></td>
                                                </tr>
                                            </form>
                                        </table>
                                    </div>
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <table id="table" class="table table-striped b-t b-b">
                                            ...
                                            ?>
                                            <tr>
                                                <td align="center"><a href="edit-debt.php?id=<?php echo codificar($row['cid']); ?>">
