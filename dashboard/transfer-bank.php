					...
					<tbody>
					  ...
					  <tr>											  					  
						  ...
						  <td>
							...
							?>
							   <a href="#" onclick="del_list_bank(<?php echo $row['cid']; ?>);">
...
<script type="text/javascript">
	function del_list_bank(cid) {
		if (window.confirm("<?php echo $L_['delete_list_bank']; ?>")) {
			window.location = "deletes/delete_list_bank.php?action=del&cid="+cid;  
		}
	}
</script>
