		<?php 
		  ...
		  <div id="con-close-modal-status-online<?php echo $row[cid]; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
				<div class="modal-dialog">				
					...
					<form action="settings/add_courier_online/update_status.php" method="post" id="formulario1">
						...
						<div class="modal-body">
							<div class="row"> 
								...
								<div class="col-md-6"> 
									<div class="form-group"> 
										<label for="field-5" class="control-label"><?php echo $NUEVAUBICACION; ?></label> 
								...
								<div class="col-md-6"> 
									<div class="form-group"> 
										<label for="field-5" class="control-label"><?php echo $L_CITYADDRESS; ?></label> 
								...
								<div class="col-md-6"> 
									<div class="form-group"> 
										<label for="dtp_input1" class="control-label"><i class="fa fa-calendar icon text-default-lter"></i>&nbsp;<?php echo $FECHAPREVISTA; ?></i></label> 
										<div class="demo-section k-content">
											<input type="text" class="form-control" name="deliverydate" id="datesstimepicker" title="datesstimepicker">
										</div><!-- input-group -->
									</div> 
								</div>
								<div class="col-md-12"> 
