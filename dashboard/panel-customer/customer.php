                ...
                <div class="wrapper-md" ng-controller="FlotChartDemoCtrl">
                    ...
                    <div class="row">
						...
						animate: 1000
                                        ...
                                        <small class="text-muted m-b"><?php echo $L_['lockerid']; ?>: <font
                                                    color="#FAD733"><?php echo $row['locker']; ?></font></small>
                                    </div>
                                    <?php } ?>
                                </div>
                                <div class="col-xs-6">
                                    ...
                                    <table ui-jq="dataTable" class="table table-striped b-t b-b">
                                        ...
                                        while ($row = mysql_fetch_array($result3)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row ["sstate"]; ?>,<?php echo $row ["scountry"]; ?>.<br>
                                                </td>
                                                <td><?php echo $row ["note"]; ?></td>
                                                <td>
                                                    <span class="label <?php echo $row['status']; ?> label-large"><?php echo $row['status']; ?></span>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
                            ...
                            <div class="table-responsive">
                                <table ui-jq="dataTable" class="table table-striped b-t b-b">
                                    ...
                                    <tr>
                                        ...
                                        <th><?php echo 'Shipping Subtotal'; ?></th>
                                    ...
                                    <tr>
										...
										AND f.cc_r='" . $currentUser['cc'] . "' ".
										"ORDER BY f.cid DESC");

                                        while ($row = mysql_fetch_array($result3)) {
                                        $ruta_imagen = $row['ruta_imagen'];
                                        ?>
                                        <td align="center"><a href="paybill.php"><img src="images/paybill.png"
                                                                                      height="28" width="34"></a></td>
                                        ...
                                        <td>
                                            <span class="label <?php echo $row['book_mode']; ?> label-large"><?php echo $row['book_mode']; ?></span>
                                        </td>
                                        ...
                                        <td><p><a href="#" class="alternar-respuesta"><img src="images/search_photo.png"
                                                                                           border="0" height="28"
                                                                                           width="50"></p></a>
                                            <p class="respuesta" style="display:none">
                                                <img onclick="javascript:this.width=500;this.height=400"
                                                     ondblclick="javascript:this.width=100;this.height=80"
                                                     src="../<?php echo $ruta_imagen; ?>" width="100"/></p>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                    </tbody>
