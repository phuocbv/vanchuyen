...
$id=$_GET['id'];
$id = decodificar($id);
$resultado = $con->query("SELECT id, locker,name,email,phone,company,state,imagen,tipo_imagen FROM tbl_clients WHERE id='$id'");
ob_end_flush();	
?>
<!DOCTYPE html>
<html lang="en">
									...
									<tbody>
									  <tr>
										<?php while($row = $resultado->fetch_assoc()){ ?> 
										  <td align="center">					
										  <a href="profile_customer.php?id=<?php echo codificar($row['id']);?>">
