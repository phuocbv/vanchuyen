...
mysql_free_result($qryEmpresa);
	...
	$your_website_logo_url = APP_URL."/dashboard/logo-image/image_logo.php?id=1'";
	$paypal_email = "$mail";  // This is your paypal email address

	$shipping_subtotal= $_GET['shipping_subtotal'];
	
	$sql_1 = "SELECT shipping_subtotal,tracking,comments FROM courier_customer WHERE shipping_subtotal = '$shipping_subtotal' AND correo ='$user_or_payer_email_address' AND payment='Pending' ";
