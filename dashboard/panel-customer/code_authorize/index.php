...
// *************************************************************************
	...
	$item_number = (!empty($_REQUEST["item_number"]))?strip_tags(str_replace("'","`",$_REQUEST["item_number"])):'';
...
<?php include "includes/javascript.validation.php"; ?>
    ...
    <div class="form_container">
    	<h1><a href="customer.php" class="navbar-brand text-lt">
          <a href class="navbar-brand block"><span><img src="../../logo-image/image_logo.php?id=1" ></span>
        </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <img src="images/payments.png"></h1>
        <?php echo $mess; ?>
            ...
            <div id="accordion">
                ...
                <div class="pane" style="display:block">
                      <?php 
						...
						$sql_1 = "SELECT shipping_subtotal,tracking,comments FROM courier_customer WHERE shipping_subtotal = '$shipping_subtotal' AND payment='Pending' ";
						...
						while($data = dbFetchAssoc($result2)) {
							...
							$item_number = $tracking;	// # tracking
							$item_name = $comments;
						}

					?>
                        <label>Description:</label>
                        <input name="item_description" id="item_description" type="text" class="long-field"  value="<?php echo $item_name;?>" onkeyup="checkFieldBack(this);" />
                        <div class="clr"></div>
						<label>Tracking:</label>
                        <input name="item_number" id="item_number" type="text" class="long-field" value="<?php echo $item_number;?>"  onkeyup="checkFieldBack(this);noAlpha(this);" onkeypress="noAlpha(this);" />
						<div class="clr"></div>
                        <label>Amount:</label>
                        <input name="amount" id="amount" type="text" class="small-field" value="<?php echo $item_amount;?>"  onkeyup="checkFieldBack(this);noAlpha(this);" onkeypress="noAlpha(this);" />
                        <div class="clr"></div>
                </div>
            	<!-- PAYMENT BLOCK -->
                ...
                <div class="submit-btn"><button name="Submit" type="submit" class="btn btn-large btn-success">SUTMIT</button></div>
