			  ...
			  <div class="panel panel-default">
				...
				<div class="table-responsive">
				  <table ui-jq="dataTable"  class="table table-striped b-t b-b">
					...
					<tbody>
						<?php  					
							$consulta_mysql="SELECT o.id,o.tracking,o.locker,o.booking_date,o.state,o.country,o.sstate,o.scountry,o.name,o.email,o.status,s.color,s.servicemode
						...
						?>
							<tr>
							 ...
							 <?php if($row ["status"] !='Cancelled' AND $row ["status"] !='Approved'){?>
							  <a href="approve.php?id=<?php echo codificar($row ["id"]); ?>">
