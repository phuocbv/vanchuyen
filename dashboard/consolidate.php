								...
								<td></br>
									...
									<?php
										...
										if(!empty($_POST['buscar'])){
											...
											$poa=mysql_query("SELECT tracking,ship_name,rev_name,r_phone,altura,ancho,longitud,totalpeso,pesoreal,status,pick_date,type,paisdestino,
											iso1,city1,r_add,cc_r,telefono1,comments FROM courier 
											...
											if($roow=mysql_fetch_array($poa)){
												...
												if($row=mysql_fetch_array($pa)){								
													...
													mysql_query("INSERT INTO caja_tmp (track,name,destina,telefono,alturas,anchos,longituds,total,totalreal,estado,fecha,tipo,
													destino,code1,ciudad,dirdesti,cc_d,teledes,nota, user) 
													VALUES ('$tracking','$ship_name','$rev_name','$r_phone','$altura','$ancho','$longitud','$totalpeso','$pesoreal','$status',
													'$pick_date','$type','$paisdestino','$iso1','$city1','$r_add','$cc_r','$telefono1','$comments','$user')");	
												}
											}else{
												echo $mensages;	
											}
										...
										<div class="col-sm-10 form-group">
											...
											<table class="table table-bordered">
												...
												<?php 
													...
													$sql="SELECT id,tracking,name,destina,dirdesti,destino,telefono,alturas,anchos,longituds,total,totalreal 
													FROM caja_tmp, courier WHERE track=courier.tracking";	
									...
									<div class="row">
										<div class="col-md-2"> 
											<div class="form-group"> 
												<label for="field-2" class="control-label"><?php echo $prefix; ?></label> 
