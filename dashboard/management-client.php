                        ...
                        <div class="col wrapper">
                            ...
                            <div class="col-xs-12">
                                ...
                                <button type="button" class="btn btn-md btn-success" data-toggle="modal"
                                        data-target="#nuevo"><i class="fa fa-user-plus"></i>
                                    <?php echo $newuser; ?></button>

                                <button type="button" class="btn btn-md btn-black"><a href="javascript:void(0);"
                                                                                      onclick="$('#importFrm').slideToggle();">Import
                                        Clients</a></button>
                            </div>

                            <form action="import_clients/importData.php" method="post" enctype="multipart/form-data"
                                  align="center" id="importFrm">
                                <a href="import_clients/tbl_clients.csv"><img src="img/csv.png" height="60" width="50">
                                    &nbsp;&nbsp;Download sample csv.</a></br></br></br>
                                ...
                                <div class="col-xs-12">
                                    <div class="table-responsive">
                                        ...
                                        <table ui-jq="dataTable" class="table table-striped b-t b-b">
                                            <thead>
                                            <tr>
                                                <?php if (isset($_SESSION['user_type']) && ($_SESSION['user_type'] == 'Administrator' || $_SESSION['user_type'] == 'Employee')) { ?>
                                                    <th><?php echo $edit; ?></th>
                                            ...
                                            if ($query->num_rows > 0) {
                                                while ($row = $query->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        <?php if (isset($_SESSION['user_type']) && ($_SESSION['user_type'] == 'Administrator' || $_SESSION['user_type'] == 'Employee')) { ?>
                                                            ...
                                                            <?php if ($_SESSION['user_type'] == 'Administrator') { ?>
                                                                <td align="center">
                                                                    <a href="deletes/delete_cliente.php?id=<?php echo $row['id']; ?>"
                                                                       onclick="return confirm('<?php echo $DELETECUSTOMER; ?>')">
                                                ...
                                                <tr>
                                                    <td colspan="10">No member(s) found.....</td>
                                                </tr>
                                            <?php } ?>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel"><i
                                                        class="fa fa-user-plus"></i><?php echo $newcustomer; ?></h4>
                                        </div>
                                        <div class="modal-body">
                                            <!--Cuerpo del modal aquí el formulario-->
                                            <form action="settings/add-new-clients/agregar.php" method="post"
                                                  class="form-horizontal" data-parsley-validate novalidate>
                                                <div class="form-group " id="gnombre">
                                                    <label for="office"
                                                           class="col-sm-2 control-label"><?php echo $namecustomers; ?></label>
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control office"
                                                               parsley-trigger="change" required name="name"
                                                               placeholder="<?php echo $namecustomers; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group " id="gnombre">
                                                ...
                                                <div class="form-group " id="gnombre">
                                                    <label for="officer_name"
                                                           class="col-sm-2 control-label"><?php echo $companys; ?></label>
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control officer_name"
                                                               iparsley-trigger="change" required name="company"
                                                               placeholder="<?php echo $namecompanys; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group" id="gapellido">
                                                    <label for="address"
                                                           class="col-sm-2 control-label"><?php echo $direccion; ?></label>
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control address"
                                                               parsley-trigger="change" required name="address"
                                                               placeholder="<?php echo $direccioncustomer; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group" id="ptelefonos">
                                                    <label for="address"
                                                           class="col-sm-2 control-label"><?php echo $telefono; ?></label>
                                                    <div class="col-sm-4">
                                                        <select type="number" class="form-control ph_no"
                                                                parsley-trigger="change" required name="code_phone"
                                                                placeholder="<?php echo $telefonocustomer2; ?>">
                                                            <option data-countrycode="AF" value="93">Afghanistan (+93)
                                                            </option>
                                                            <option data-countrycode="AL" value="355">Albania (+355)
                                                            </option>
                                                            <option data-countrycode="DZ" value="213">Algeria (+213)
                                                            </option>
                                                            <option data-countrycode="AS" value="1684">American Samoa
                                                                (+1684)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="AQ" value="0">Antarctica (+0)
                                                            </option>
                                                            <option data-countrycode="AG" value="1268">Antigua and
                                                                Barbuda (+1268)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="BA" value="387">Bosnia and
                                                                Herzegovina (+387)
                                                            </option>
                                                            <option data-countrycode="BW" value="267">Botswana (+267)
                                                            </option>
                                                            <option data-countrycode="BV" value="0">Bouvet Island (+0)
                                                            </option>
                                                            <option data-countrycode="BR" value="55">Brazil (+55)
                                                            </option>
                                                            <option data-countrycode="IO" value="246">British Indian
                                                                Ocean Territory (+246)
                                                            </option>
                                                            <option data-countrycode="BN" value="673">Brunei Darussalam
                                                                (+673)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="TD" value="235">Chad (+235)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="CC" value="672">Cocos (Keeling)
                                                                Islands (+672)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="CD" value="242">Congo, the
                                                                Democratic Republic of the (+242)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="CI" value="225">Cote D'Ivoire
                                                                (+225)
                                                            </option>
                                                            <option data-countrycode="HR" value="385">Croatia (+385)
                                                            </option>
                                                            <option data-countrycode="CU" value="53">Cuba (+53)</option>
                                                            <option data-countrycode="CY" value="357">Cyprus (+357)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="TF" value="0">French Southern
                                                                Territories (+0)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="GE" value="995">Georgia (+995)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="GU" value="1671">Guam (+1671)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="HM" value="0">Heard Island and
                                                                Mcdonald Islands (+0)
                                                            </option>
                                                            <option data-countrycode="VA" value="39">Holy See (Vatican
                                                                City State) (+39)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="IR" value="98">Iran, Islamic
                                                                Republic of (+98)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="KP" value="850">Korea, Democratic
                                                                People's Republic of (+850)
                                                            </option>
                                                            <option data-countrycode="KR" value="82">Korea, Republic of
                                                                (+82)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="LA" value="856">Lao People's
                                                            ...
                                                            <option data-countrycode="LY" value="218">Libyan Arab
                                                                Jamahiriya (+218)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="MK" value="389">Macedonia, the
                                                                Former Yugoslav Republic of (+389)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="MU" value="230">Mauritius (+230)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="MD" value="373">Moldova, Republic
                                                                of (+373)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="MM" value="95">Myanmar (+95)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="AN" value="599">Netherlands
                                                                Antilles (+599)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="NF" value="672">Norfolk Island
                                                                (+672)
                                                            </option>
                                                            <option data-countrycode="MP" value="1670">Northern Mariana
                                                                Islands (+1670)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="PS" value="970">Palestinian
                                                            ...
                                                            <option data-countrycode="PN" value="0">Pitcairn (+0)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="RU" value="70">Russian Federation
                                                                (+70)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="KN" value="1869">Saint Kitts and
                                                                Nevis (+1869)
                                                            </option>
                                                            <option data-countrycode="LC" value="1758">Saint Lucia
                                                                (+1758)
                                                            </option>
                                                            <option data-countrycode="PM" value="508">Saint Pierre and
                                                                Miquelon (+508)
                                                            </option>
                                                            <option data-countrycode="VC" value="1784">Saint Vincent and
                                                                the Grenadines (+1784)
                                                            </option>
                                                            <option data-countrycode="WS" value="684">Samoa (+684)
                                                            </option>
                                                            <option data-countrycode="SM" value="378">San Marino
                                                                (+378)
                                                            </option>
                                                            <option data-countrycode="ST" value="239">Sao Tome and
                                                                Principe (+239)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="CS" value="381">Serbia and
                                                                Montenegro (+381)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="SK" value="421">Slovakia (+421)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="GS" value="0">South Georgia and
                                                                the South Sandwich Islands (+0)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="SJ" value="47">Svalbard and Jan
                                                                Mayen (+47)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="SY" value="963">Syrian Arab
                                                                Republic (+963)
                                                            </option>
                                                            <option data-countrycode="TW" value="886">Taiwan, Province
                                                                of China (+886)
                                                            </option>
                                                            <option data-countrycode="TJ" value="992">Tajikistan
                                                                (+992)
                                                            </option>
                                                            <option data-countrycode="TZ" value="255">Tanzania, United
                                                                Republic of (+255)
                                                            </option>
                                                            <option data-countrycode="TH" value="66">Thailand (+66)
                                                            </option>
                                                            <option data-countrycode="TL" value="670">Timor-Leste
                                                                (+670)
                                                            </option>
                                                            <option data-countrycode="TG" value="228">Togo (+228)
                                                            </option>
                                                            <option data-countrycode="TK" value="690">Tokelau (+690)
                                                            </option>
                                                            <option data-countrycode="TO" value="676">Tonga (+676)
                                                            </option>
                                                            <option data-countrycode="TT" value="1868">Trinidad and
                                                                Tobago (+1868)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="TM" value="7370">Turkmenistan
                                                                (+7370)
                                                            </option>
                                                            <option data-countrycode="TC" value="1649">Turks and Caicos
                                                                Islands (+1649)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="US" value="1">United States (+1)
                                                            </option>
                                                            <option data-countrycode="UM" value="1">United States Minor
                                                                Outlying Islands (+1)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="VN" value="84">Viet Nam (+84)
                                                            </option>
                                                            <option data-countrycode="VG" value="1284">Virgin Islands,
                                                                British (+1284)
                                                            </option>
                                                            <option data-countrycode="VI" value="1340">Virgin Islands,
                                                                U.s. (+1340)
                                                            </option>
                                                            ...
                                                            <option data-countrycode="YE" value="967">Yemen (+967)
                                                            </option>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="number" class="form-control ph_no"
                                                               parsley-trigger="change" required name="phone"
                                                               placeholder="<?php echo $telefonocustomer1; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group" id="ptelefonos">
                                                    <label for="address"
                                                    ...
                                                    <div class="col-sm-4">
                                                        <select type="number" class="form-control ph_no"
                                                                parsley-trigger="change" required name="code_phone1"
                                                                placeholder="<?php echo $telefonocustomer2; ?>">
                                                            <option data-countrycode="AF" value="93">Afghanistan (+93)
                                                            </option>
                                                            <option data-countrycode="AL" value="355">Albania (+355)
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="number" class="form-control ph_no"
                                                               parsley-trigger="change" required name="telefono"
                                                               placeholder="<?php echo $telefonocustomer2; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group" id="gusuario">
                                                    <label for="officer_name"
                                                           class="col-sm-2 control-label"><?php echo $Usuario; ?></label>
                                                    <div class="col-sm-5">
                                                        <input type="email" class="form-control officer_name"
                                                               id="emailAddress" parsley-trigger="change" required
                                                               name="email" placeholder="demo@demo.com">
                                                    </div>
                                                    <div class="col-sm-5">
                                                        <input type="password" class="form-control off_pwd"
                                                               parsley-trigger="change" required name="pwd"
                                                               placeholder="<?php echo $password; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group" id="gusuario">
                                                    <label for="officer_name"
                                                           class="col-sm-2 control-label"><?php echo $paisorigen; ?></label>
                                                    <div class="col-sm-5">
                                                        <select class="fa-glass booking_form_dropdown form-control"
                                                                name="country" id="country1" parsley-trigger="change"
                                                                required>
                                                    ...
                                                    <div class="col-sm-5">
                                                        <select type="text"
                                                                class="fa-glass booking_form_dropdown form-control"
                                                                name="department" id="state1" parsley-trigger="change"
                                                                required>
                                                            <option value=""><?php echo $L_State_first; ?></option>
                                                        </select>
                                                    </div>
                                                    <div class="col-sm-5" style="display:none">
                                                        <select name="iso" id="iso1"
                                                                class="fa-glass booking_form_dropdown form-control">
                                                ...
                                                <div class="form-group" id="gusuario">
                                                    <label for="officer_name"
                                                           class="col-sm-2 control-label"><?php echo $cciudad; ?></label>
                                                    <div class="col-sm-5">
                                                        <select type="text"
                                                                class="fa-glass booking_form_dropdown form-control"
                                                                name="state" id="city1" parsley-trigger="change"
                                                                required>
                                                            <option value=""><?php echo $L_City_first; ?></option>
                                                        </select>
                                                    </div>
                                                    <div class="col-sm-5">
                                                        <input type="text" class="form-control off_pwd"
                                                               parsley-trigger="change" required name="zipcode"
                                                               placeholder="<?php echo $codigopostal; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group" id="gusuario">
                                                    <label for="officer_name"
                                                           class="col-sm-2 control-label"><?php echo $language; ?></label>
                                                    <div class="col-sm-5">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-offset-2 col-sm-10">
                                                        ...
                                                        <div class="checkbox">
                                                            <label class="i-checks i-checks-sm">
                                                                <input type="checkbox" name="type" value="u"
                                                                       onclick="return false" checked>
                                                                <i></i>
                                                                <?php echo $usertype; ?>
                                                            </label>
