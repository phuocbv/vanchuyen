...
$cid= $_GET['cid'];
$cid = decodificar($cid);
$ss=mysql_query("SELECT * FROM courier_online WHERE cid=$cid");
			...
			<tbody>
				<tr>
					<td>						
						...
						<p style="text-align: center;" ><font face="arial" color="black" size=7><?php echo $rr['cons_no']; ?></font></p>
						<hr />
							...
							<tbody>
								...
								<tr style="border: hidden;">
									...
									<td>
										...
										<p><font size=4><?php echo $rr['Qnty']; ?></font></p>
									</td>
								</tr>
							</tbody>
						</table>
						...
						<p style="text-align: left;"><img src="../logo-image/image_logo.php?id=1"></p>
					</td>
				</tr>
			</tbody>
		</table>
