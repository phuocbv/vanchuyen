							...
							<div class="row">
									...
									<legend><?php echo $Informaciondeenvio; ?>:</legend>
										...
										<div class="row">
											...
											<div class="col-sm-3 form-group">
												...
												<input name="book_mode" value="<?php echo $book_mode; ?>" class="form-control" >
								...
								<fieldset class="col-md-6">
									...
									<div class="col-sm-6 form-group">
										...
										<input name="ciudad" required value="<?php echo $ciudad; ?>" class="form-control"  >																			
									</div>															
									<div class="col-sm-6 form-group">
										<label for="zipcode" class="control-label"><i class="fa fa-angle-double-right icon text-default-lter"></i>&nbsp;<?php echo $ALACIUDAD; ?></label>
										<input name="city1" required value="<?php echo $city1; ?>" class="form-control"  >																				
									</div>		
