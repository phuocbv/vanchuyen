...
<!--                                                    <input type="text" class="form-control" name="locker" id="locker" autocomplete="on" list="customers" value="--><?php //if (isset($_POST['Receivername'])) echo $_POST['Receivername']?><!--">-->
                                                ...
                                                <div class="col-sm-6 form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="Receivername" id="Receivername" autocomplete="on" list="customers" value="<?php if (isset($_POST['Receivername'])) echo $_POST['Receivername']?>">
                                                </div>
                                            </div>
											...
											<div class="row">
												<div class="col-sm-3 form-group">
													<label  class="control-label"><?php echo $DIRECCION; ?>&nbsp;<?php if ($v13==true){?><span class="error"><em><?php echo $L_['mandatory']; ?></em></span><?php }?></label>
													<input type="text"  class="form-control" name="Receiveraddress" id="Receiveraddress" value="<?php if (isset($_POST['Receiveraddress'])) echo $_POST['Receiveraddress']?>" >
												</div>

												<div class="col-sm-3 form-group">
													<label  class="control-label"><i class="fa fa-phone icon text-default-lter"></i>&nbsp;<?php echo $TELEFONO; ?>&nbsp;<?php if ($v15==true){?><span class="error"><em><?php echo $L_['mandatory']; ?></em></span><?php }?></label>
													<input type="tel"  class="form-control" name="Receiverphone" id="Receiverphone" value="<?php if (isset($_POST['Receiverphone'])) echo $_POST['Receiverphone']?>" >
												</div>

												<div class="col-sm-3 form-group">
													<label  class="control-label"><i class="fa fa-phone icon text-default-lter"></i>&nbsp;<?php echo $TELEFONO2; ?>&nbsp;<?php if ($v16==true){?><span class="error"><em><?php echo $L_['mandatory']; ?></em></span><?php }?></label>
													<input type="tel"  class="form-control" name="telefono1" id="Receivertelefono1" value="<?php if (isset($_POST['telefono1'])) echo $_POST['telefono1']?>" >
												</div>

												<div class="col-sm-3 form-group">
													<label class="control-label"><?php echo $CEDULA; ?>&nbsp;<?php if ($v17==true){?><span class="error"><em><?php echo $L_['mandatory']; ?></em></span><?php }?></label>
													<input type="text" class="form-control" name="Receivercc_r" id="Receivercc_r" value="<?php if (isset($_POST['Receivercc_r'])) echo $_POST['Receivercc_r']?>">
												</div>
												<div class="col-sm-3 form-group">
													<label class="control-label"><i class="fa fa-angle-double-right icon text-default-lter"></i>&nbsp;<strong><?php echo $PAISDESTINO; ?></strong>&nbsp;<?php if ($v18==true){?><span class="error"><em><?php echo $L_['mandatory']; ?></em></span><?php }?></label>
														<input  type="text"  class="form-control" name="paisdestino" id="Receivercountry1" value="<?php if (isset($_POST['paisdestino'])) echo $_POST['paisdestino']?>" >
												</div>
												<div class="col-sm-3 form-group">
													<label class="control-label"><strong><?php echo $L_STATE; ?></strong>&nbsp;<?php if ($v19==true){?><span class="error"><em><?php echo $L_['mandatory']; ?></em></span><?php }?></label>
													<input type="text" class="form-control" name="state1" id="Receiverstate1" value="<?php if (isset($_POST['state1'])) echo $_POST['state1']?>" >

												</div>
												<div class="col-sm-3 form-group" >
													<label class="control-label"><strong><?php echo $CODIGO; ?></strong>&nbsp;<?php if ($v20==true){?><span class="error"><em><?php echo $L_['mandatory']; ?></em></span><?php }?></label>
														<input type="text" class="form-control" name="iso1"  id="Receiveriso1"  value="<?php if (isset($_POST['iso1'])) echo $_POST['iso1']?>" >
												</div>

												<div class="col-sm-3 form-group">
													<label class="control-label"><strong><?php echo $CIUDAD; ?></strong>&nbsp;<?php if ($v21==true){?><span class="error"><em><?php echo $L_['mandatory']; ?></em></span><?php }?></label>
													<input type="text" class="form-control" name="city1"  id="Receivercity1" value="<?php if (isset($_POST['city1'])) echo $_POST['city1']?>" >
												</div>
												<div class="col-sm-3 form-group">
													<label class="control-label"><strong><?php echo $CODIGOPOSTAL; ?></strong>&nbsp;<?php if ($v22==true){?><span class="error"><em><?php echo $L_['mandatory']; ?></em></span><?php }?></label>
														<input  type="text" class="form-control" name="zipcode1" id="Receiverzipcode1" value="<?php if (isset($_POST['zipcode1'])) echo $_POST['zipcode1']?>">
												</div>
												<div class="col-sm-9 form-group">
													<label class="control-label"><?php echo $EMAIL; ?><font color="#FF6100"><?php echo $notaemail; ?></font>&nbsp;<?php if ($v23==true){?><span class="error"><em><?php echo $L_['mandatory']; ?></em></span><?php }?></label>
											...
											<div class="form-group">
												...
												<div>
													<div class="demo-section k-content">
														<input type="date" class="form-control" name="Packupdate" id="datetimepicker" title="datetimepicker" style="width: 100%;" >
													</div><!-- input-group -->
												</div>
											</div>
											...
											<div class="row">
												...
												<div class="col-sm-8 form-group">
													...
													<div>
														<div class="demo-section k-content">
															<input type="date" class="form-control" name="Schedule" id="datestimepicker" title="datestimepicker">
														</div><!-- input-group -->
													</div>
													</fieldset>
													<div class="col-md-6 text-left">
														</br></br>
														<button type="submit"  class="btn btn-large btn-success"><?php echo $GUARDARENVIO; ?></button>
													</div>
												</div>
											</div>
										</div>
