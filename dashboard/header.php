    ...
    <header id="header" class="app-header navbar" role="menu">
        ...
        <div class="navbar-header bg-dark">
            ...
            <a href="index.php" class="navbar-brand text-lt">
                <a href class="navbar-brand block"><span><img src="logo-image/image_logo.php?id=1" height="34"
                                                              width="170"></span>
                </a>
                <!-- / brand -->
        </div>
        ...
        <div class="collapse pos-rlt navbar-collapse box-shadow bg-white-only">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <i class="on md b-white bottom"></i>
                            ...
                            <span class="hidden-sm hidden-md"><?php echo $mensaje; ?>
                                &nbsp;&nbsp;<strong><?php echo $_SESSION['user_name']; ?></strong></span> <b
                                    class="caret"></b>
                        </a>
                    <?php } ?>
                    ...
                    <ul class="dropdown-menu animated fadeInRight w">
                        ...
                        while ($row = mysql_fetch_array($result4)) {
                            ...
                            <li>
                                ...
                                <a href="edit-profile.php?cid=<?php echo codificar($row['cid']); ?>"><i
                                            class="fa fa-users icon text-default-lter"></i>&nbsp;&nbsp;<?php echo $perfil; ?>
                                </a>
                            </li>
                            <?php
                        }
                        ...
                        <?php if (isset($_SESSION['user_type']) && $_SESSION['user_type'] == 'Employee') { ?>
                            ...
                            while ($row = mysql_fetch_array($result90)) {
                                ?>
                                <li>
                                    <a href="edit-profile-user.php?cid=<?php echo codificar($row['cid']); ?>"><i
                                                class="fa fa-users icon text-default-lter"></i>&nbsp;&nbsp;<?php echo $perfil; ?>
                                    </a>
                                </li>
                            <?php }
                        ...
                        <li>
                            <a href="logout.php"><i
                                        class="fa fa-sign-out icon text-default-lter"></i>&nbsp;&nbsp;<?php echo $salir; ?>
                            </a>
                        </li>
                    </ul>
                    <!-- / dropdown -->
