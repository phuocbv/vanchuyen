										...
										######## GUARDAMOS LA INFORMACION DE LA FACTURA
											if(!empty($_POST['econtenedor'])){
												...
												while($row=mysql_fetch_array($ss)){
													...
													$neto34= $_POST['neto4'];
													$neto4=$neto34;
													mysql_query("INSERT INTO consolidate (cons_no,track,name,destina,telefono,total,neto1,neto2,neto3,neto,totalreal,neto4,paquetes,
													estado,fecha,tipo,destino,code1,ciudad,dirdesti,cc_d,teledes,nota, fecha_status,econtenedor,etrack,master,comentario,user) VALUES 
													('$cons_no','".$row['track']."','".$row['name']."','".$row['destina']."','".$row['telefono']."','".$row['total']."','$neto1',
													'$neto2','$neto3','$neto','".$row['totalreal']."','$neto4','$paquetes','".$row['estado']."','".$row['fecha']."',
													'".$row['tipo']."','".$row['destino']."','".$row['code1']."','".$row['ciudad']."','".$row['dirdesti']."','".$row['cc_d']."',
													'".$row['teledes']."','".$row['nota']."','$fecha_status','$econtenedor','COEE-$econtenedor','$master','$comentario','$user')");
